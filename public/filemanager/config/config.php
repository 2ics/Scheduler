...
$upload_dir = '/img/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../img/source/'; // relative path from filemanager folder to upload folder (with final /)
