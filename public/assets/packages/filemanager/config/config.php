...
$base_url ="http://".$_SERVER['HTTP_HOST']."/PrintQuote";  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/public/img/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../public/img/source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../public/img/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
