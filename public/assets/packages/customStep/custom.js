...
Custom = function(id, name, reference, caliper, next, previous, quantities, outSource) {
  this.init(id, name, reference, caliper, next, previous, quantities, outSource);
};

Custom.prototype = {

  init: function(id, name, reference, caliper, next, previous, quantities, outSource) {
    this.id = id;
    this.name = name;
  ...
  changeQuantity: function(id, value){
    ...
    changeReference: function(value){
        this.reference = value;
    },

    changeCaliper: function(value){
        this.caliper = value;
    },

  changeOutSource: function(value){
