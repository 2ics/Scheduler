	...
	<div class="col-md-12">
      <form id="projectForm" method="post" 
			...
			<div class="col-md-12 text-right">
				<button type="button" class="btn btn-danger pull-left"><span class="glyphicon glyphicon-trash"></span> Delete Project</button>
